...
def calcular_kin_onda(anio, mes, dia):
    ...
    try:
        ...
        #valor_mes = valores_mes[nombre_mes]
...
def procesa_kin_onda(anio, mes, dia):
    ...
    registro = {
        "nro_kin": calcular_kin_onda(anio, mes, dia)["kin"],
        "nro_onda": calcular_kin_onda(anio, mes, dia)["onda"],
...
def api_calcular_kinmaya():
    ...
    try:
        ...
        # Llamar a función principal
        resultado = procesa_kin_onda(anio, mes, dia)
...
if __name__ == "__main__":
    print(calcular_kin_onda(1985, 11, 17))  # ejemplo
